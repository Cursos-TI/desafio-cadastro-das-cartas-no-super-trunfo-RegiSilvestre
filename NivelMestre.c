...
int main() {
    ...
    resultadoSuperPoder = superPoderCarta1 > superPoderCarta2;
        ...
        printf("Números de Pontos Turisticos: %d pontos\n", numpt1);
        ...
        printf("População: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoPop);
        printf("Área: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoArea);
        printf("PIB: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoPib);
        printf("Número de Pontos Turisticos: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoNumpt);
        printf("Densidade Populacional: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoDensPop);
        printf("PIB per Capita: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoPibPcap);
        printf("Super Poder: Carta 1 (1) VS Carta 2 (0) - Vencedor: %d\n", resultadoSuperPoder);
